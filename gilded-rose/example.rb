...
# Superclass of the actual item types.
class AbstractItem
...
# The default item type, anything not matched to one of the other types below.
...
# An item factory. Not named ItemFactory with a ::build_item method,
# only because the tests expect `Item::new`.
module Item
